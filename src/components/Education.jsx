...
const Education = () => {
    const coursework = [
        "Software Engineering I-IV",
        "Human Computer Interactions",
        "Technical Writing",
        "Design Systems & Algorithms",
        "Calculus & Statistics",
        "Machine Learning",
            ...
            <div className="max-w-6xl mx-auto px-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    >
                        ...
                        <div>
                            <p className="text-sm font-semibold text-slate-400 mb-3 uppercase tracking-wider">Relevant
                                Coursework</p>
                            <div className="flex flex-wrap gap-2">
                                {coursework.map((course, index) => (
                                    <span key={index}
                                          className="text-xs font-medium px-2 py-1 bg-slate-700 border border-slate-600 rounded-md text-slate-200">
                    {course}
                  </span>
                                ))}
                            </div>
                    ...
                    >
                        ...
                        <p className="text-slate-300 text-sm leading-relaxed mb-4">
                            Initiated in Spring 2023 into the nation's only fraternity exclusive to STEM majors. Elected
                            by peers to serve as Chapter President and re-elected for a second term, becoming
                            the <strong className="text-white">only member to serve multiple terms</strong> since the
                            chapter's refounding in 2017.
                        </p>

                        <p className="text-slate-300 text-sm leading-relaxed">
                            Served as the primary campus representative and chairman of the executive council,
                            facilitating all chapter meetings. Acted as the core liaison between the chapter and
                            critical stakeholders, including the <strong className="text-white">National Organization,
                            Alumni Board, Office of Fraternity and Sorority Life (OFSL), and Interfraternity Council
                            (IFC)</strong>.
                        </p>
                    </motion.div>
